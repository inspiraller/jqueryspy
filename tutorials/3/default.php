...
<html>
    <head>
		<title>Jquery Spy &gt; Tutorials &gt; 3</title>		   
...
include(getRoot('/includes/tutorial_nav.php')); ?>      
				...
				<div id="main">
					<h2>Test Ajax Type</h2>
					<div class="mod">
						<p>Click to view <a href="/tutorials/3/example.htm" target="_blank">Demo</a></p>
<h3>Demo HTML:</h3>						
						<code>
&lt;!DOCTYPE html&gt;
&lt;html&gt;
