...
<html>
    <head>
		<title>Jquery Spy &gt; Tutorials &gt; 5</title>		   
...
include(getRoot('/includes/tutorial_nav.php')); ?>      
				...
				<div id="main">
					...
					<div class="mod">
						<p>Click to view <a href="/tutorials/5/example.htm" target="_blank">Demo</a></p>
<h3>Demo HTML:</h3>						
						<code>
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;	   
	...
	&lt;script&gt;
		test("Test ajax and config maximum wait time of 1 second", function () {
			var spy = $.spy({
				ajax:{
					success:{
				...
				config:{
					intMaxWaitSeconds:1 // timer to check ajax is returned after 1 second.
				}
			});
			$.ajax({
